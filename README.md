...
```mermaid
  flowchart LR
    Transaction -- Guarda Operación con estado pendiente --> transactionDatabase[(Database)]
    Transaction -- Envía evento de Operación --> Anti-Fraud
    Anti-Fraud -- Envía Operación con estado aprobado --> Transaction
    Anti-Fraud -- Envía Operación con estado rechazado --> Transaction
    Transaction -- Actualiza estado de Operación -> transactionDatabase[(Database)]
```
